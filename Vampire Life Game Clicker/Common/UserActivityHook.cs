...
namespace Vampire_Life_Game_Clicker.Common
{
    ...
    public delegate void MouseActionHandler(MouseAction action, int x, int y);
    public class UserActivityHook
    {
        ...
        public event MouseActionHandler MouseActions;
        /// <summary>
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (OnMouseActivity != null))
            {
                ...
                {
                    MouseActions(action, mouseHookStruct.pt.x, mouseHookStruct.pt.y);
                }
                //raise it
